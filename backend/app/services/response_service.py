...
from app.schemas.response import (
    ResponseCreate, ResponseInDB, BulkResponseCreate,
...
class ResponseService:
    ...
    def create_response(self, session_id: int, response_data: ResponseCreate) -> ResponseInDB:
        """
    ...
    def create_bulk_responses(self, bulk_data: BulkResponseCreate) -> List[ResponseInDB]:
        """
    ...
    def get_session_responses_with_questions(self, session_id: int) -> List[ResponseWithQuestion]:
        """
        ...
        for response in responses:
            result.append(ResponseWithQuestion(
                id=response.id,
