...
from app.schemas.question import (
    ...
    QuestionTree, QuestionReorder, QuestionMove,
    QuestionStatistics, QuestionWithChildren
)
...
class QuestionService:
    ...
    def update_question(self, question_id: int, update_data: QuestionUpdate) -> QuestionResponse:
        """
        Update a question.
        ...
        if update_data.parent_id is not None and update_data.parent_id != existing.parent_id:
            if update_data.parent_id:
                ...
                if self.question_dao._would_create_cycle(question_id, update_data.parent_id):
                    raise HTTPException(
    ...
    def get_base_questions(self, category: Optional[str] = None) -> List[QuestionResponse]:
        """
