...
@router.post("/session/{session_id}", response_model=ResponseInDB, status_code=status.HTTP_201_CREATED)
def create_response(
    session_id: int,
...
@router.post("/bulk", response_model=List[ResponseInDB], status_code=status.HTTP_201_CREATED)
...
@router.get("/session/{session_id}/category-stats", response_model=List[CategoryStatistics])
